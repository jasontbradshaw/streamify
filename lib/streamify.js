...
Streamify.prototype._handleSocketConnect = function (socket) {
  // don't create a new recorder if one connected to us already
  clearTimeout(this.forkTimeout);
...
Streamify.prototype._forkRecorder = function () {
  ...
  if (this.socket === null) {
    // fork a detached recorder process that we communicate with using socket.io
